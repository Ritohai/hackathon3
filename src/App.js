...
function App() {
  ...
  return (
    <div className="App">
      <img src="https://vanhoadoisong.vn/wp-content/uploads/2022/05/tong-hop-100-hinh-anh-mat-trang-dep-nhat-07.jpg" />
      <div className="cards">
        <Card item={item} updateQuery={update} setItem={setItem}/>
      </div>
    </div>
  );
}
